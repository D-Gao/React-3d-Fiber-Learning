...
void main() {
    ...
    // Smoke
    vec4 smoke2 = texture(uPerlinTexture, smokeUv);
    ...
    smoke = smoothstep(0.3, 1.0, smoke); // first parameter is the bottom value where it begins and then it eases until the end using the second parameter
