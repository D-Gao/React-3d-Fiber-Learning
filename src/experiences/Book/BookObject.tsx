...
const Page = ({
  ...
  const manualSkinnedMesh = useMemo(() => {
    ...
    //in total 6 face for the box geometry
    const materials = [
      ...pageMaterials,
      new MeshStandardMaterial({
        color: whiteColor,
  ...
  useFrame((_, delta) => {
    ...
    // 4,5 corrispond to the front and back material of a page
    (
      skinnedMeshRef.current.material as MeshStandardMaterial[]
    )[4].emissiveIntensity = (
      skinnedMeshRef.current.material as MeshStandardMaterial[]
    )[5].emissiveIntensity = MathUtils.lerp(
      (skinnedMeshRef.current.material as MeshStandardMaterial[])[4]
        .emissiveIntensity,
      emissiveIntensity,
      0.1
    );
