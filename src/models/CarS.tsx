...
Command: npx gltfjsx@6.4.1 public/models/car.glb -o src/models/CarS.tsx --typescript -r public 
*/
...
export function CarS(props: JSX.IntrinsicElements["group"]) {
  ...
  useFrame((state, delta) => {
    ...
    wheelRef.current?.children.forEach((item) => {
      (item as THREE.Mesh).rotateX(state.clock.getElapsedTime() * -0.001);
    });
  });
